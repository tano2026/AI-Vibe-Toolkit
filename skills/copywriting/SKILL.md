...
## Facebook Post Mechanics (Platform-Specific)

Facebook có cơ chế riêng khác hẳn các nền tảng khác. Áp dụng các quy tắc này cho MỌI bài viết Facebook.

### "See More" Fold

~400-480 ký tự đầu (3-4 dòng trên mobile) là phần hiển thị trước khi user phải tap "See More". **Hook phải nằm trong khoảng này.**

**Hook hiệu quả Above the Fold:**
- Câu chuyện bắt đầu giữa chừng (in medias res): *"Nghỉ việc hồi thứ 6. Kể từ đó..."*
- Con số + cảm xúc: *"2 tiếng ngồi chờ visa — cuối cùng cũng xong."*
- Câu hỏi specific: *"Có ai từng bị delay chuyến bay 6 tiếng ở Tân Sơn Nhất không?"*

**Hook thất bại:**
- *"Hôm nay mình muốn chia sẻ với các bạn về..."* (vague, không có gì để hook)
- *"Chào buổi sáng cả nhà!"* (filler)
- Context dài dòng trước khi vào vấn đề

### Post Format Pattern

**Profile / Page Post (Ngắn):**
```
[Hook 1-2 câu] → [Nội dung chính 2-4 câu] → [CTA 1 câu]
```
Mỗi đoạn cách nhau 1 dòng trống. Dùng emoji 1-2 cái/cảm xúc, không trang trí.

**Page Post (Dài / Storytelling):**
```
[Hook mạnh above fold]
[Context ngắn]
[Phần chính — emotional truth / chi tiết bất ngờ]
[Kết thúc — không inspirational]
[CTA]
```

### Claude-ism Detection (cho Facebook)

Các từ/cụm cần tránh vì nghe rất AI:

| ❌ Tránh | ✅ Thay bằng |
|---|---|
| "I wanted to share..." | [vào thẳng vấn đề] |
| genuinely, comprehensive, straightforward | really, honestly, just, actually |
| utilize, implement, leverage, navigate | use, try, deal with, figure out |
| however, therefore, furthermore | but, so, and, anyway |
| on this journey, throughout this process | [xóa] |
| "Remember, you've got this!" | [xóa hoặc làm specific] |

### Emotion-First Approach

Facebook content thắng bằng cảm xúc thật, không bằng công thức engagement. Trước khi viết:

1. **Cảm xúc thúc đẩy bài này là gì?** (vui, bực, biết ơn, hào hứng, cô đơn, tự hào, nhẹ nhõm)
2. **Ai sẽ đọc?** (dì, bạn cấp 3, đồng nghiệp, người lạ trong group, khách hàng)
3. **Bạn cần gì từ họ?** (kết nối, lời khuyên, sự công nhận, giúp đỡ, để được lắng nghe)

**Viết TỪ cảm xúc đó, không viết ĐỂ đạt thuật toán.**

### Key Differences: Facebook vs Các Platform Khác

| Yếu tố | Facebook | LinkedIn | X.com |
|---|---|---|---|
| Tone | Ấm áp, personal | Chuyên nghiệp | Sắc sảo, tin tức |
| Độ dài | 150-800 ký tự (short wins) | 600-1500 ký tự | 280 ký tự |
| Emoji | Cảm xúc, ít | Chuyên nghiệp | Tùy context |
| See More fold | Critical (~400 ký tự) | Không quan trọng | N/A (ngắn) |
| Hook | Story/emotion-driven | Insight-driven | Opinion/hot take |
| Nguy cơ lớn nhất | Nghe như LinkedIn | Nghe như robot | Nghe quá dài dòng |

### Research: Facebook Content Writing Tools & Skills

Khi cần viết content Facebook cho brand, tham khảo các nguồn sau:

**MCP Servers (quản lý đăng bài & quảng cáo):**
- `pipeboard-co/meta-ads-mcp` (⭐950) — 42 tools quản lý Meta Ads campaign, creatives, insights
- `brijr/meta-mcp` (⭐180) — Meta Marketing API, tự deploy Cloudflare Worker
- `talm/eclincher-mcp-server` (⭐0) — Social MCP, publish 8 networks

**Skills (content writing):**
- `K0rsantan/facebook-post-writer` — Skill chuyên Facebook, emotion-first, See More fold, Claude-ism detection. References: post-formats.md, examples.md, claude-isms.md
- `coreyhaines31/marketingskills` — 23 skills marketing (có `social-content`, copywriting, content-strategy). Cài: `npx skills add coreyhaines31/marketingskills`
- `bradautomates/head-of-content` (⭐108) — Research content viral trên IG/YouTube/TikTok. Cần Apify API
- `wilwaldon/Claude-Code-Content-Marketing-Toolkit` (⭐6) — Tổng hợp skills + MCP content creation

**Quy tắc khi chọn:**
- Content organic → dùng skill (facebook-post-writer, coreyhaines31 social-content)
- Quảng cáo/chạy campaign → dùng MCP (meta-ads-mcp, meta-mcp)
- Research thị trường → dùng head-of-content + Apify

---

## Vietnamese Travel Facebook Content (ABTRIP & Travel Brands)

Khi viết content Facebook cho travel brand Việt Nam (vé máy bay, visa, tour), áp dụng các nguyên tắc riêng:

### Brand Tone Quy Tắc Cứng

| Brand | Tone | Đặc điểm ngôn ngữ |
|---|---|---|
| **ABTRIP** (B2C) | Ấm áp, đáng tin | Xưng hô thân thiện (bạn/mình), cảm xúc, gần gũi |
| **An Bình** (B2B) | Chuyên nghiệp, dứt khoát | Trang trọng, số liệu, quyền lực |

⚠️ **KHÔNG BAO GIỜ nhầm lẫn giữa 2 brand.** Mỗi lần viết phải xác định brand trước.

### Cấu Trúc Post Facebook Cho Travel

```
[Hook] — Câu mở đầu gây chú ý (câu hỏi / con số / cảm xúc)
[Body] — 2-3 đoạn ngắn, mỗi đoạn 1-2 câu
[CTA] — Kêu gọi hành động rõ ràng (inbox, click link, comment)
...
**Vé máy bay:**
- Hook giá sốc: "Đà Nẵng chỉ từ 299k — bạn có tin không?"
- Khung giờ vàng: đăng sáng sớm (6-8h) hoặc tối (19-21h)
- Visual: ảnh điểm đến chất lượng cao, chèn giá
- Tần suất: 3-5 posts/tuần

**Visa & Du lịch:**
- Content giáo dục: hướng dẫn thủ tục, kinh nghiệm xin visa
- Hook: "Mắc 1 lỗi này là hỏng visa — đọc ngay kẻo muộn"
- Visual: infographic checklist, ảnh passport/visa
- Tần suất: 2-3 posts/tuần

### Nguyên Tắc Content Facebook Cho Travel

- **Ngắn = tốt:** Post FB đọc lướt, tối đa 3-5 câu, xuống dòng sau mỗi câu
- **Visual-first:** Ảnh/video chất lượng là 80% thành công
- **Kích thích FOMO:** "Chỉ còn 5 chỗ", "Giá đặc biệt hôm nay"
- **Tương tả:** Đặt câu hỏi cuối post để tăng comment
- **Không copy-paste:** Viết lại cho từng nền tảng, ko đăng 1 nội dung lên cả FB, Instagram, TikTok y hệt nhau

### Ví Dụ Post ABTRIP (Vé Máy Bay)

```
✈️ Sài Gòn → Phú Quốc chỉ từ 499k!

Đặt ngay hôm nay, bay tuần sau — còn 12 chỗ cho khung giờ đẹp.

🎯 Giá đã gồm thuế phí
🎯 Hành lý xách tay 7kg
🎯 Bay thẳng, không transit

Inbox em để đặt vé nhanh nhất ạ!

#ABTRIP #VéMáyBay #PhúQuốc #DuLịchGiáRẻ
```

### Ví Dụ Post Visa Page

```
📌 XIN VISA NHẬT — 5 điều bạn KHÔNG ĐƯỢC LÀM

1. Nộp hồ sơ thiếu giấy tờ gốc
2. Không chứng minh tài chính rõ ràng
3. Lịch trình du lịch chung chung
4. Đặt vé máy bay trước khi có visa
5. Quên kiểm tra passport còn hạn

Bạn đã từng mắc lỗi nào? Comment bên dưới để được tư vấn!

#VisaNhật #XinVisa #DuLịchNhậtBản
```
