...
> ⚠️ Ghi chú kho: các file `rules/*.md` được liệt kê ở trên hiện CHƯA có mặt trong kho
> (chỉ mới có file index này). Nếu cần dùng chi tiết một rule cụ thể, phải research/fetch
> riêng nội dung rule đó từ nguồn ECC gốc trước khi áp dụng — đừng giả định nội dung.
